...
public class DirContents {
    ...
    public func firstWithExtension(_ ext: String) -> (name: FileName?, index: Int) {
    ...
    public func nextWithExtension(_ ext: String, start: Int) -> (name: FileName?, index: Int) {
        var i = start
        var ending = ""
        if ext.starts(with: ".") {
    ...
    public func firstContaining(words: [String]) -> (name: FileName?, index: Int) {
        return nextContaining(words: words, start: 0)
    }
    
    /// Return the next directory entry containing all of the passed words,
    /// ignoring case (upper or lower).
    public func nextContaining(words: [String], start: Int) -> (name: FileName?, index: Int) {
